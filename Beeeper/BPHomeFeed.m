...
-(void)getHomeFeedWithCompletionBlock:(completed)compbloc{
    ...
    [request setDidFinishSelector:@selector(homeFeedFinished:)];
    
    [request setDidFailSelector:@selector(homeFeedFailed:)];
    
    [request startAsynchronous];
    
}

-(void)homeFeedFinished:(ASIHTTPRequest *)request{
...
-(void)homeFeedFailed:(ASIHTTPRequest *)request{
...
-(void)getLocalFriendsFeed:(completed)compbloc{
    ...
    [self parseResponseString:filePath];
}
