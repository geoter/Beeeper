...
//        
//        UIViewController *rootViewController = ((UINavigationController *)contentViewController).viewControllers[0];
//        
//        if ([self.contentViewController isKindOfClass:[UINavigationController class]]) {
//            UIViewController *rootViewController2 = ((UINavigationController *)self.contentViewController).viewControllers[0];
//            
//            if ([rootViewController isKindOfClass:[rootViewController2 class]]) {
...
//        }
//        else{
//            if ([rootViewController isKindOfClass:[self.contentViewController class]]) {
//                self.contentViewController = contentViewController;
//                closeMenu ? [self closeMenu] : nil;
//                return;
//            }
//        }
//    }
//    else if ([self.contentViewController isKindOfClass:[contentViewController class]]) {
//        self.contentViewController = contentViewController;
//        closeMenu ? [self closeMenu] : nil;
//        return;
//    }
