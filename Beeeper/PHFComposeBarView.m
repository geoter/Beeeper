...
CGFloat const kButtonHeight               = 28.0f;
CGFloat const kButtonTouchableOverlap     =  6.0f;
CGFloat const kButtonRightMargin          = 7.0f;
...
- (UIButton *)textContainer {
    if (!_textContainer) {
        CGRect textContainerFrame = CGRectMake(kHorizontalSpacing,
                                               ...
                                               [self bounds].size.width - 30 - kButtonRightMargin,
        ...
        [_textContainer setBackgroundColor:[UIColor colorWithRed:238/255.0 green:241/255.0 blue:243/255.0 alpha:1]];
...
- (UITextView *)textView {
    if (!_textView) {
        ...
        [_textView setTextColor:[UIColor colorWithRed:125/255.0 green:124/255.0 blue:124/255.0 alpha:1]];
        [self setupDelegateChainForTextView];
    }
...
- (UILabel *)placeholderLabel {
    if (!_placeholderLabel) {
        ...
        [_placeholderLabel setTextColor:[UIColor colorWithRed:125/255.0 green:124/255.0 blue:124/255.0 alpha:1]];
