...
-(void)setBadgeValue:(NSInteger)value {
  if(value != 0 || self.displayWhenZero) {
      CGSize numberSize = [[NSString stringWithFormat:@"%d", value] sizeWithAttributes:
                           @{NSFontAttributeName:
                                 self.font}];
...
-(void)drawRect:(CGRect)rect {
  if(self.badgeValue != 0 || self.displayWhenZero) {
    ...
    CGSize numberSize = [[NSString stringWithFormat:@"%d", self.badgeValue] sizeWithAttributes:
                           @{NSFontAttributeName:
                                 self.font}];
